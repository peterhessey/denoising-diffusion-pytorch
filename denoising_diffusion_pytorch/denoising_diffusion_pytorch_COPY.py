...
# repeat noise is not use, so simply returns random noise in shape given
...
class GaussianDiffusion(nn.Module):
    def __init__(self, denoise_fn, timesteps=1000, loss_type='l1', betas = None):
        ...
        during the construction. This is to 
        ...
        # register buffers are used as these variables are not considered parameters of the model
